...
export const Logo = props => (
  ...
  >
    <defs>
      ...
      >
        <stop offset={0} stopColor='#d806d8' />
        <stop offset={1} stopColor='#cea312' />
      </linearGradient>
      <filter
      ...
      >
        ...
        <feComposite
          ...
          result='shadow'
        />
        <feOffset dx={-3.7} dy={-4} in='SourceGraphic' result='offset-1' />
        <feOffset dx={3.7} dy={4} in='shadow' result='offset-2' />
        <feMerge>
